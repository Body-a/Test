...
public class Controller implements Initializable {
   ...
   public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        collectionAddressBook.getPersonList().addListener((ListChangeListener<Person>) change -> updateList());
    ...
    void showDialog(ActionEvent event) {
        ...
        switch (clickedButton.getId()){
            ...
            case "btnEdit":
                ...
                break;
            case "btnDelete":
                collectionAddressBook.delete(tableView.getSelectionModel().getSelectedItem());
                break;
        }
